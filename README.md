...
```
    ...
    ## alpha_Intercept      0.25      0.03     0.19     0.31 1.00      961     1128
    ## gamma_Intercept      0.32      0.03     0.27     0.38 1.00     1119     1226
    ## lambda_Intercept     1.23      0.28     0.78     1.89 1.00     1127     1644
    ## 
    ## Further Distributional Parameters:
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.07      0.00     0.07     0.08 1.00     1634     1447
    ## 
...
```
    ...
    ## Regression Coefficients:
    ##                  Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## alpha_Intercept      0.21      0.03     0.14     0.27 1.01      609      800
    ## gamma_Intercept      0.37      0.03     0.32     0.42 1.00      701      889
    ## lambda_Intercept     1.02      0.19     0.70     1.45 1.00      781     1118
    ## A_Intercept          0.06      0.01     0.05     0.08 1.00     1754     1551
    ## phi_Intercept       -0.84      0.12    -1.07    -0.61 1.00     2297     1750
    ## 
    ## Further Distributional Parameters:
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.06      0.00     0.05     0.07 1.00     2112     1622
    ## 
    ## Draws were sampled using sampling(NUTS). For each parameter, Bulk_ESS
    ## and Tail_ESS are effective sample size measures, and Rhat is the potential
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
